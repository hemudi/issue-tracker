...
import { $Tab, $TabItem } from '@/components/common/Tabs/style';
import { listItem, ITabs } from '@/components/common/Tabs/type';
import { IButtonProps, IButtonStyleProps } from '@/components/common/Button/type';
