...
public class IssueController {
    ...
    @Operation(summary = "새 이슈 작성")
    @PostMapping
    public ResponseEntity<IssueDetailResponse> postIssue(
        @RequestBody @Valid IssueCreateForm createForm) {
        return ResponseEntity.ok(issueService.create(createForm));
    }
}
